...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { class_teacher: @classroom.class_teacher, form: @classroom.form, stream: @classroom.stream }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { class_teacher: @classroom.class_teacher, form: @classroom.form, stream: @classroom.stream }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
