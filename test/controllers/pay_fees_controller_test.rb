...
class PayFeesControllerTest < ActionController::TestCase
  ...
  test "should create pay_fee" do
    assert_difference('PayFee.count') do
      post :create, pay_fee: { admission_number: @pay_fee.admission_number, amount: @pay_fee.amount, form: @pay_fee.form, pay_method: @pay_fee.pay_method, stream: @pay_fee.stream, student_name: @pay_fee.student_name }
    end
  ...
  test "should update pay_fee" do
    patch :update, id: @pay_fee, pay_fee: { admission_number: @pay_fee.admission_number, amount: @pay_fee.amount, form: @pay_fee.form, pay_method: @pay_fee.pay_method, stream: @pay_fee.stream, student_name: @pay_fee.student_name }
    assert_redirected_to pay_fee_path(assigns(:pay_fee))
  end
